...
const getAllJiraVersions = (domain, project, email, apiToken) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        const response = yield axios_1.default.get(`https://${domain}.atlassian.net/rest/api/3/project/${project}/versions`, {
            headers: {
